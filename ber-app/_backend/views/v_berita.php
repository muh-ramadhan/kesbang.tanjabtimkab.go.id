										...
										<tbody>
											...
											foreach($artikel as $key => $row){
												...
												<tr class="odd">
													...
													<td>
														<center>
															<input type="checkbox" name="cek[]" class="case" value="<?php echo $row['id_berita']; ?>" id="id<?php echo $no; ?>" rel="ck" title="Pilih">
														</center>
													</td>
													<td>
														<a class="bold" href="<?php echo base_url(); ?>berita/edit/<?php echo $row['id_berita']."/".$judul."/";?>"> <?php echo $row['judul']; ?> </a>
													</td>
													...
													<td>
														<?php if ($row['jangkrik']=='Y') {?>
															<a href="<?php echo base_url(); ?>berita/nonaktif/<?php echo $row['id_berita']."/".$judul."/";?>" class="btn btn-info btn-circle btn-lg"><i class="fa fa-check"></i> </a>
														<?php } else {?>
															<a href="<?php echo base_url(); ?>berita/aktif/<?php echo $row['id_berita']."/".$judul."/";?>" 	class="btn btn-warning btn-circle btn-lg"><i class="fa fa-times"></i> </a>
														<?php } ?>
													</td>
            ...
            -->
       			...
       			<div class="form-group">
       				...
       				<select class="form-control"  name="kategori" id="kategori">
       					...
       					<?php $dataa = $this->M_dataadmin->pilihkategori();
       			...
       			<div class="form-group">
       				...
       				<select class="form-control"  name="daerah" id="daerah">
       					...
       					<?php $dataa = $this->M_dataadmin->pilihdaerah();
       					foreach($dataa->result_array() as $raw) { ?>
