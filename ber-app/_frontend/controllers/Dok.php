...
class Dok extends CI_Controller {
	...
	{
		$data['deskripsi']="Dokumen Kesbangpol Kab. Tanjung Jabung Timur - ".$this->M_data->titlesistem(1);
		$data['judulapp']="Dokumen Kesbangpol Kab. Tanjung Jabung Timur | ".$this->M_data->titlesistem(1);
		$data['judulan']="Dokumen Kesbangpol Kab. Tanjung Jabung Timur";
		$data["katdokumen"]=$this->M_data->katdokumen();
		$data['keyword']=$this->M_data->keyword(1);
		$data['postingby']="Admin Kesbangpol Kab. Tanjung Jabung Timur";
