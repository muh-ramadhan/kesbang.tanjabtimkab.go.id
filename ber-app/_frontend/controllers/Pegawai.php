...
class Pegawai extends CI_Controller {
	...
	public function index ()
	{
		...
		$data['judulapp']="Semua Pejabat/Staff Kab. Tanjung Jabung Timur | ".$this->M_data->titlesistem(1);
		$data['judulan']="Semua Pejabat/Staff Kab. Tanjung Jabung Timur";
		$data['deskripsi']=$this->M_data->deskripsi(1);
		$data['menu'] = $this->M_data->getMenu2(2,"");
		$data['keyword']=$this->M_data->keyword(1);
		$data['postingby']="Admin Kesbang Kab. Tanjung Jabung Timur";
