                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?php echo base_url()."dokumens/kategori/".$row->id_katdokumen."/".seo_link($row->nama_katdokumen);?>">
...
<a href="<?php echo base_url(); ?>dokumens/<?php echo $row->nama_file;?>" target="_blank"><b>Download</b></a>
<?php } else { ?>
